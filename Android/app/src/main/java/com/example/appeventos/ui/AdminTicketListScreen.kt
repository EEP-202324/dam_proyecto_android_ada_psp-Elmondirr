...
@Composable
fun AdminTicketListScreen(navController: NavController) {
...
fun AdminfetchTickets(context: Context, updateTickets: (List<Entrada>) -> Unit) {
...
@Composable
fun AdminTicketItem(entrada: Entrada, navController: NavController) {
